...
return [
    ...
    */
    ...
    'options' => [
        'application' => env('APP_NAME', 'MyPathshala User API'),
        'repository' => 'git@gitlab.com:mpsrc/be/user.git',
    ...
    */
    ...
    'hosts' => [
        '139.59.36.48' => [
            'stage' => 'prod1',
            'deploy_path' => '/var/www/usvc.my-pathshala.com',
            'user' => 'root',
        ],
        '159.89.170.171' => [
            'stage' => 'prod2',
